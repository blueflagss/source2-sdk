#ifndef CS2_PROJECT_UTL_MEMORY_HPP
#define CS2_PROJECT_UTL_MEMORY_HPP
...
CUtlMemory< T, I >::CUtlMemory( int nGrowSize, int nInitAllocationCount ) : m_pMemory( 0 ), m_nAllocationCount( nInitAllocationCount ), m_nGrowSize( nGrowSize )
{
    ...
    if ( m_nAllocationCount ) {
        m_pMemory = ( T * ) g_interfaces.m_mem_alloc->alloc( m_nAllocationCount * sizeof( T ) );
    }
}
...
void CUtlMemory< T, I >::ConvertToGrowableMemory( int nGrowSize )
{
    ...
    if ( m_nAllocationCount ) {
        ...
        T *pMemory = ( T * ) g_interfaces.m_mem_alloc->alloc( nNumBytes );
...
void CUtlMemory< T, I >::Grow( int num )
{
    ...
    if ( m_pMemory ) {
        auto ptr = g_interfaces.m_mem_alloc->alloc( m_nAllocationCount * sizeof( T ) );
...
inline void CUtlMemory< T, I >::EnsureCapacity( int num )
{
    ...
    if ( m_pMemory ) {
        m_pMemory = ( T * ) g_interfaces.m_mem_alloc->realloc( m_pMemory, m_nAllocationCount * sizeof( T ) );
    } else {
        m_pMemory = ( T * ) g_interfaces.m_mem_alloc->alloc( m_nAllocationCount * sizeof( T ) );
    }
}
...
void CUtlMemory< T, I >::Purge()
{
    if ( !IsExternallyAllocated() ) {
        if ( m_pMemory ) {
            g_interfaces.m_mem_alloc->free( ( void * ) m_pMemory );
            m_pMemory = 0;
        }
        m_nAllocationCount = 0;
    }
...
#endif//CS2_PROJECT_UTL_MEMORY_HPP
