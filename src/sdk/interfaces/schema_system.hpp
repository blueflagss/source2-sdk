...
public:
    ...
    __forceinline CUtlTSHash< schema_class_binding_t * > get_classes( )
    {
        return m_classes;
    }
private:
    ...
    PAD( 0x450 );
    CUtlTSHash< schema_class_binding_t * > m_classes;// 0x0558
    PAD( 0x2804 );
};

class c_schema_system {
public:
    inline c_schema_system_type_scope *global_type_scope( )
    {
        return utils::get_method< c_schema_system_type_scope *( __thiscall * ) ( void * ) >( this, 11 )( this );
    }

    inline c_schema_system_type_scope *find_type_scope_for_module( const char *module )
    {
        return utils::get_method< c_schema_system_type_scope *( __thiscall * ) ( void *, const char * ) >( this, 13 )( this, module );
    }
};
