...
void __fastcall hooks::frame_stage_notify::hook( void *ecx, int a1 )
{
    ...
    globals::local = ( g_interfaces.m_engine_client->is_connected( ) && g_interfaces.m_engine_client->is_in_game( ) ) ? c_base_player::get_local_player< c_base_player_pawn* >( 0 ) : nullptr;
}
